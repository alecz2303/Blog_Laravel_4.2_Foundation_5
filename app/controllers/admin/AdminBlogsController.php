...
class AdminBlogsController extends AdminController {
    ...
    public function getData()
    {
        ...
        ->add_column('actions', '<a href="{{{ URL::to(\'admin/blogs/\' . $id . \'/edit\' ) }}}" class="button tiny iframe" >{{{ Lang::get(\'button.edit\') }}}</a>
                <a href="{{{ URL::to(\'admin/blogs/\' . $id . \'/delete\' ) }}}" class="button tiny alert iframe">{{{ Lang::get(\'button.delete\') }}}</a>
            ')
